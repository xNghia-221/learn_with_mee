...
part of 'errorMessage.model.dart';
...
class _$_ErrorMessageModel implements _ErrorMessageModel {
  ...
  @override
  String toString() {
    return 'ErrorMessageModel(field: $field, message: $message)';
  }
...
abstract class _ErrorMessageModel implements ErrorMessageModel {
  factory _ErrorMessageModel(
      {@JsonKey(name: 'field') final String? field,
      @JsonKey(name: 'message') final String? message}) = _$_ErrorMessageModel;
